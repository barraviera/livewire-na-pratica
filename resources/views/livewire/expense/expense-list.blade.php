...
<!-- max-w-7xl largura pra fica do mesmo tamanho limite da dashboard -->
<!-- mx-auto centraliza o elemento -->
<!-- py-15 padding no eixo y 15 cada lado e o px é no eixo x -->
    ...
    <table class="table-auto w-full mx-auto">
        ...
        <tbody>
            ...
            <tr>
                ...
                <!-- 2 casas decimais, ponto decimal usando virgula e ponto no restante  -->
                <td class="px-4 py-2 border">
                    <span class="{{ $exp->type == 1 ? 'text-green-600' : 'text-red-600' }}">R$ {{number_format($exp->amount, 2, ',', '.')}}</span>
                </td>
                <!-- se exitir uma data iremos mostra-la expense_date, mas se nao existir iremos mostrar a data de created_at -->
