<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createPlan" class="w-full max-w-7xl mx-auto mt-4">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6">
                ...
                <!-- veja que colocamos plan.name para que possamos receber todos os inputs como array no PlanCreate.php -->
