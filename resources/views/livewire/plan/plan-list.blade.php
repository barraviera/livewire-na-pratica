<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right mb-4 mt-4">
        <a href="{{route('plans.create')}}" class="flex-shrink-0 bg-green-700 hover:bg-green-500 border-green-500 hover:border-green-900 text-sm border text-white py-2 px-6 rounded">Criar Plano</a>
    </div>
